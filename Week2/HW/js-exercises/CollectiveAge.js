...
const getMembersAge = hackYourFutureMembers.map (hackYourFutureMember => hackYourFutureMember.age);
console.log(getMembersAge);
const ageSum = getMembersAge.reduce((total, age) => total + age, 0);
console.log("The collective age of the HYF team is: " + ageSum + ".");